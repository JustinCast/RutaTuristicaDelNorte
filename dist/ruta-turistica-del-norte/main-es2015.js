...
let ShowImagesComponent = class ShowImagesComponent {
    constructor(images, fireStorage, snackbar, dialogRef, _common) {
        this.images = images;
...
let TourComponent = class TourComponent {
    constructor(_tours, route, _router, _dialog, _tour) {
        this._tours = _tours;
        this.route = route;
        this._router = _router;
        this._dialog = _dialog;
    ...
    ngOnInit() {
        ...
        if (this.route.snapshot.paramMap.get("id_service") &&
            ...
            this.tour = this._tours.services.find(t => t.id_service === Number(id_service));
    ...
    getServiceRates(id_service) {
        this._tours.getServiceRates(id_service).subscribe({
            ...
            error: (err) => this._tours.handleError(err)
        });
    }
...
let TouristicOfferComponent = class TouristicOfferComponent {
    constructor(_service, _common, _tour) {
        this._service = _service;
        this._common = _common;
        this._tour = _tour;
        this.limit = 6;
